...
public class PrePostProcessor {
    ...
    // model input image size v1 : 512 v2 : 1024
    static int mInputWidth = 640;
    static int mInputHeight = 640;

    // model output is of size 25200*(num_of_class+5)
    private static int mOutputRow = 25200; // as decided by the YOLOv5 model for input image of size 640*640 v1 : 16128 v2 : 64512
